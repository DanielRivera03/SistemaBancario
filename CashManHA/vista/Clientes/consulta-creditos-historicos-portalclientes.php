...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Listado Solicitudes Cr&eacute;ditos Cancelados (Hist&oacute;rico) </title>
        <!-- Favicon icon -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Solicitudes Cr&eacute;ditos Cancelados Clientes CashMan H.A [Hist&oacute;rico]</h4><br>
