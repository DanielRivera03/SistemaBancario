            ...
            <ul class="metismenu" id="menu">
                ...
                <li <?php if ($_GET['cashmanhagestion'] == "consulta-transacciones-general-cuentas-clientes" || $_GET['cashmanhagestion'] == "retiros-cuentas-ahorros-clientes" || $_GET['cashmanhagestion'] == "deposito-cuentas-ahorros-clientes") {
                    ...
                    <ul aria-expanded="false">
                        ...
                        ?>
                            <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=consulta-transacciones-cuentas-clientes-gerencia">Consultar Mi Cuenta Ahorro</a></li>
                        <?php } ?>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=consulta-listado-cuotas-clientes-morosos-gerencia">Listado Clientes Morosos</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                        <svg fill="LightSlateGrey" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                ...
                <li <?php if ($_GET['cashmanhagestion'] == "consulta-especifica-tickets-reportes-plataforma") {
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=registrar-ticket-problema-plataforma-gerencia">Registrar Reportes Problemas</a></li>
                    </ul>
                </li>
                <li <?php if ($_GET['cashmanhagestion'] == "detalle-mensajeria-cashmanha-usuarios") {
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=envio-mensajeria-usuarios-cashmanha-gerencia">Enviar Nuevo Mensaje</a></li>
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=mensajeria-cashmanha-usuarios-gerencia">Bandeja de Entrada</a></li>
                ...
                <li><a class="ai-icon" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=visualizar-mis-notificaciones-usuarios-gerencia" aria-expanded="true">
                        <svg fill="LightSlateGrey" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            <path fill="none" d="M0 0h24v24H0z" />
